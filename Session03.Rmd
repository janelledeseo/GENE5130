...
diff.df <- as.data.frame(sigs.df)
diff.df <- diff.df %>%
  filter(padj < 0.05, log2FoldChange > , baseMean > 100)
...
It might be more informative to create plots for genes that are both up-regulated and down-regulated. Subset your data above and plot the GO enrichment for both up-regulated and down-regulated.
```{R}
